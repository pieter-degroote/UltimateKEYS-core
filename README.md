...
The additional customized Compose Key sequences (Multi_key) have not been included in this release/repository, since these may change more frequently over time. That way, only the pre-defined Compose Key sequences on the Linux installation are applicable.
